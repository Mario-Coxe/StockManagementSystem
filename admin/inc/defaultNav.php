...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
  <div class="container">
    ...
    </a> <button class="navbar-toggler order-1" type="button" data-toggle="collapse" data-target="#navbarCollapse"
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
            ...
            <li><a href="#" class="dropdown-item">Outra ação</a></li>

            <li class="dropdown-divider"></li>

            <!-- Nível do dropdown dois -->
            <li class="dropdown-submenu dropdown-hover">
              <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false" class="dropdown-item dropdown-toggle">Passar o mouse para ação</a>
              <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                <li>
                  <a tabindex="-1" href="#" class="dropdown-item">Nível 2</a>
                </li>

                <!-- Nível do dropdown três -->
                <li class="dropdown-submenu">
                  <a id="dropdownSubMenu3" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false" class="dropdown-item dropdown-toggle">Nível 2</a>
                  <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow">
                    <li><a href="#" class="dropdown-item">Nível 3</a></li>
                    <li><a href="#" class="dropdown-item">Nível 3</a></li>
                  </ul>
                </li>
                <!-- Fim do nível três -->
    ...
    <!-- Links da direita da barra de navegação -->
    <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
      <!-- Menu suspenso de mensagens -->
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Início da mensagem -->
            <div class="media">
              <img src="<?php echo base_url ?>dist/img/user1-128x128.jpg" alt="Avatar do Usuário"
          ...
          <a href="#" class="dropdown-item">
            <!-- Início da mensagem -->
            <div class="media">
              <img src="<?php echo base_url ?>dist/img/user8-128x128.jpg" alt="Avatar do Usuário"
          ...
          <a href="#" class="dropdown-item">
            <!-- Início da mensagem -->
            <div class="media">
              <img src="<?php echo base_url ?>dist/img/user3-128x128.jpg" alt="Avatar do Usuário"
                class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
                ...
                <p class="text-sm">O assunto está aqui</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 horas atrás</p>
              </div>
            </div>
            <!-- Fim da mensagem -->
