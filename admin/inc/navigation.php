...
<!-- Contêiner da Barra Lateral Principal -->
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
  <!-- Logotipo da Marca -->
  <a href="<?php echo base_url ?>admin" class="brand-link bg-primary text-sm">
    <img src="<?php echo validate_image($_settings->info('logo')) ?>" alt="Logotipo da Loja"
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('#receive-nav').click(function () {
      ...
      uni_modal("Digite o Número de Rastreamento", "transaction/find_transaction.php");
    })
  })
</script>