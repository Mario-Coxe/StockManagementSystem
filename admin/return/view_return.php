...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Registro de Devolução -
    ...
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">Código de Devolução</label>
                    <div>
                        <?php echo isset($return_code) ? $return_code : '' ?>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url . '/admin?page=return/manage_return&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=return' ?>">Voltar para a Lista</a>
    </div>
</div>
...
<script>$(function () {
        $('#print').click(function () {
            ...
            _head.find('title').text("Registro de Devolução - Visualização para Impressão")
            ...
            _el.append('<div class="d-flex justify-content-center">' +
                ...
                '<h4 class="text-center">Registro de Devolução</h4>' +
                '</div>' +
                '<div class="col-1 text-right">' +
                '</div>' +
                '</div><hr/>')
