...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Detalhes do Pedido de Compra -
            <?php echo $po_code ?>
        </h4>
    </div>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        <th class="text-center py-1 px-2">Qtde</th>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url . '/admin?page=purchase_order/manage_po&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=purchase_order' ?>">Voltar para a
            Lista</a>
    </div>
</div>
...
<script>$(function () {
        $('#print').click(function () {
            ...
            _el.append('<div class="d-flex justify-content-center">' +
                ...
                '<h4 class="text-center">Pedido de Compra</h4>' +
                '</div>' +
                '<div class="col-1 text-right">' +
                '</div>' +
                '</div><hr/>')
