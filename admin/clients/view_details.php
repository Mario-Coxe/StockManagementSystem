            ...
            <fieldset class="w-100">
                ...
                <div class="col-12">
                    ...
                    <dl>
                        ...
                        <dd class="pl-3">
                            <?php echo isset($meta['gender']) ? $meta['gender'] : '' ?>
                        </dd>
                        <dt class="text-info">Data de Nascimento:</dt>
                        <dd class="pl-3">
                            <?php echo isset($meta['dob']) ? date("d/m/Y", strtotime($meta['dob'])) : '' ?>
                        </dd>
                        ...
                        <dd class="pl-3">
                            <?php echo isset($meta['address']) ? $meta['address'] : '' ?>
                        </dd>
...
<div class="form-group">
    <div class="col-12">
        <div class="d-flex justify-content-end align-items-center">
            <button class="btn btn-light btn-flat" type="button" id="cancel" data-dismiss="modal">Fechar</button>
        </div>
    </div>
</div>
<script>
    $(function () {
        ...
        $('#print').click(function () {
            ...
            _head.find('title').text("Detalhes do Pagamento - Visualização para Impressão")
            ...
            _el.append('<div class="d-flex justify-content-center">' +
                ...
                '<h4 class="text-center">Detalhes do Pagamento</h4>' +
                '</div>' +
                '<div class="col-1 text-right">' +
                '</div>' +
                '</div><hr/>')
