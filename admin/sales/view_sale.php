...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Registro de Vendas -
            <?php echo $sales_code ?>
        </h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">Código de Vendas</label>
                    <div>
                        <?php echo isset($sales_code) ? $sales_code : '' ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div>
                            <?php echo isset($client) ? $client : '' ?>
                        </div>
                    </div>
                </div>
            </div>
            <h4 class="text-info">Itens</h4>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url . '/admin?page=sales/manage_sale&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=sales' ?>">Voltar à Lista</a>
    </div>
</div>
...
<script>$(function () {
        $('#print').click(function () {
            ...
            _head.find('title').text("Registro de Vendas - Visualização de Impressão")
            ...
            _el.append('<div class="d-flex justify-content-center">' +
                ...
                '<h4 class="text-center">Registro de Vendas</h4>' +
                '</div>' +
                '<div class="col-1 text-right">' +
                '</div>' +
                '</div><hr/>')
